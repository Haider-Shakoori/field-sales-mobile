...
android { namespace="com.wesoft.fieldsales"; compileSdk=flutter.compileSdkVersion; ndkVersion=flutter.ndkVersion
 defaultConfig { applicationId="com.wesoft.fieldsales"; minSdk=23; targetSdk=flutter.targetSdkVersion; versionCode=flutter.versionCode; versionName=flutter.versionName }
