...
class SecretStore {
  ...
  Future<String> _stableUuid(String key) async { var v = await _storage.read(key: key); if (v == null || v.isEmpty) { v = const Uuid().v4(); await _storage.write(key: key, value: v); } return v; }
